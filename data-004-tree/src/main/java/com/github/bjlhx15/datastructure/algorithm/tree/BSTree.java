...
public class BSTree<T extends Comparable<T>> {
    ...
    public void displayTree() {
        ...
        ArrayList<BSTNode> currentLayerNodes = new ArrayList<BSTNode>();
        ...
        while (layerIndex <= depth) {
            ...
            for (int i = 0; i < currentLayerNodes.size(); i++) {
                BSTNode node = currentLayerNodes.get(i);
    ...
    private int getDepth(BSTNode currentNode, int initDeep) {
    ...
    private ArrayList getAllNodeOfThisLayer(List parentNodes) {
        ArrayList list = new ArrayList<BSTNode>();
        BSTNode parentNode;
        for (int i = 0; i < parentNodes.size(); i++) {
            parentNode = (BSTNode) parentNodes.get(i);
            if (parentNode != null) {
