...
public class RBTree<T extends Comparable<T>> {
    ...
    public void displayTree() {
        ...
        ArrayList<RBTNode> currentLayerNodes = new ArrayList<RBTNode>();
        ...
        while (layerIndex <= depth) {
            ...
            for (int i = 0; i < currentLayerNodes.size(); i++) {
                RBTNode node = currentLayerNodes.get(i);
    ...
    private int getDepth(RBTNode currentNode, int initDeep) {
    ...
    private ArrayList getAllNodeOfThisLayer(List parentNodes) {
        ArrayList list = new ArrayList<RBTNode>();
        RBTNode parentNode;
        for (int i = 0; i < parentNodes.size(); i++) {
            parentNode = (RBTNode) parentNodes.get(i);
            if (parentNode != null) {
