package com.github.bjlhx15.datastructure.algorithm.tree.huffman;
...
//            codeSet.put(currentNode.key,currentCode);
//        }else{//如果不是叶子节点，必定同时包含左右子节点，这种节点没有对应关键字
//            //转向左子节点需要将当前代码追加0
//            buildCodeSet(currentNode.left,currentCode+"0");
//            //转向右子节点需要将当前代码追加1
//            buildCodeSet(currentNode.right,currentCode+"1");
//        }
//    }
}
